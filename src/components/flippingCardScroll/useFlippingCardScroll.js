...
function useFlippingCardScroll({ sectionRef, headerRef, containerRef, cardRefs }) {
  ...
  useEffect(() => {
    ...
    const header = headerRef.current.querySelector('h1');
    ...
    function initAnimations() {
      ...
      mm.add('(max-width: 999px)', () => {
        ...
        [container, header, ...cards].forEach((el) => {
          if (el) el.style = '';
        });
        return {};
      });
